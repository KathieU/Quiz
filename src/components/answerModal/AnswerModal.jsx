...
const AnswerModal = ({
  ...
  return (
    <div className="answer-modal slide-up">
      ...
      >
        <h1 className="answer-percentage">{correctAnswer}</h1>
        <h2 className="answer-title">{answerText}</h2>
        <p className="answer-description">
          {/* Include any additional description here if needed */}
        </p>
        <div className="general-button-container">
...
AnswerModal.propTypes = {
  ...
  onNext: PropTypes.func.isRequired,
  isLastQuestion: PropTypes.bool.isRequired,
  bgImage: PropTypes.string.isRequired, // Background image for the modal
  answerText: PropTypes.string.isRequired, // Answer text displayed in the modal
};
